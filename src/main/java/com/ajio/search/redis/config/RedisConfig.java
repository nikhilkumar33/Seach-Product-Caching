package com.ajio.search.redis.config;
...
public class RedisConfig 
{
	...
	public RedisConnectionFactory redisConnectionFactory() {
		...
		RedisStandaloneConfiguration redisConfig = new RedisStandaloneConfiguration("unique-goldfish-27574.upstash.io",
				6379);
		redisConfig.setUsername("default");
		redisConfig.setPassword("AWu2AAIncDE3MmExYzNiMzNmZmQ0NDBmOTU4YWRjYWIzNWQ1YzJjMnAxMjc1NzQ");
